...
- [x] Recreate ZDOS Microcosm Home / Microcosm screen
- [x] Add offline-first status markers and default-deny messaging
...
- [x] Configure Expo app metadata for ZDOS Microcosm
